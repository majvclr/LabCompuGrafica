...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas Maria Jose Vaca Lara", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   view = glm::translate(view, glm::vec3(0.0f,0.0f,-12.0f));
		...
		glBindVertexArray(VAO);
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-2.0f, 0.0f, 0.0f)); // cubo 1 izquierda
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(1.0f, -1.0f, 1.5f)); //
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f)); // cubo 2 centro
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(-7.0f, -3.0f, -5.0f)); //
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f)); // cubo 3 derecha
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		...
		//
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-1.0f, 1.2f, 0.0f)); // cubo 4 izquierda
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(1.0f, 1.2f, 0.0f)); // cubo 5 derecha
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.0f, 2.4f, 0.0f)); // cubo 6 arriba
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
